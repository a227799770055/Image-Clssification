...
train_directory = '/media/insign/Transcend/Workspace/Dataset/1_CecumAnus_Classified'
valid_directory = '/media/insign/Transcend/Workspace/Dataset/1_CecumAnus_Classified'
# Set the model save path
PATH="classified_1011.pth" 
...
elif train_mode=='yolo':
    print("\nLoading morphology yolo as feature extractor ...\n")  
    model_ft = Morphology()
